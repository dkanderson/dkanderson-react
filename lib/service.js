...
const updateUser = async (data, username) => {
    ...
    const response = await User.updateOne({ username: username }, data, (err) => {
...
const deleteUser = async (username) => {
    ...
    const response = await User.deleteOne({ username: username }, (err) => {
        if (err) {
            error = err;
            error.type = "error"
        }
...
module.exports = {
    ...
    updateUser: (data, username) => updateUser(data, username),
