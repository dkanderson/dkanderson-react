...
class UpdateArtwork extends Component{
    ...
    componentWillMount(){
        fetch(`/api/artwork/${this.props.id}`)
            ...
            .then(response => {
                this.setState({
                    ...
                    infobox_id: response.infobox_id,
                    original_img: response.original_img,
                    painting_sm: response.painting_sm,
                    painting_lg: response.painting_lg,
    ...
    render(){
        return(
            <div id="add-new-artwork" className="add-new-artwork-wrapper form-wrapper">
                ...
                <Button 
                        ...
                        className = "update-artwork-btn btn form-btn"
                        onClick = {this.handleSubmit}
                        title = "Update New Artwork"
                    />
