    ...
    getProjectData(){
        ...
        .then(response => {
            this.setState({
                ...
                client_banner_class: response.client_banner_class,
                tech: response.tech,
                project_bg: response.project_bg,
                screenshot_a: response.screenshot_a,
        ...
        return(
            <div id="add-new-projects" className="add-new-project-wrapper form-wrapper">
                ...
                <Button 
                        ...
                        className = "update-project-btn btn form-btn"
